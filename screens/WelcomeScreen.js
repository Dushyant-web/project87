    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          ...
          <Text
            style={{justifyContent:'center', alignSelf:'center', fontSize:30,color:'Black',margin:10}}
            >Registration</Text>
          <TextInput
  ...
  render(){
    return(
      <View style={styles.container}>
        ...
        <View style={{borderWidth:15,alignItems:'center',width:"90%",borderColor:"white",marginLeft:15,marginTop:28,}}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'orange', fontSize:18, fontWeight:'bold',marginLeft:55,marginTop:20}}>Username</Text>
          ...
          <Text style={{color:'orange', fontSize:18, fontWeight:'bold',marginLeft:55}}>Password</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
